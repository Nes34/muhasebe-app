...
import { exportCashTransactionsToExcel } from '../lib/excel';
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            {transactions.length > 0 && (
              <button onClick={() => exportCashTransactionsToExcel(transactions)} className="flex items-center gap-2 px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm"><Download size={16} /> Excel</button>
            )}
            {selectedRegister && (
