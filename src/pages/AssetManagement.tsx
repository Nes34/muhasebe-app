...
const CATEGORIES = [
  ...
  { value: 'laptop', label: 'Dizüstü Bilgisayar', icon: Package },
  { value: 'monitor', label: 'Monitör', icon: Package },
  { value: 'printer', label: 'Yazıcı', icon: Package },
  { value: 'phone', label: 'Telefon', icon: Package },
  { value: 'tablet', label: 'Tablet', icon: Package },
  { value: 'server', label: 'Sunucu', icon: Package },
  { value: 'network', label: 'Ağ Ekipmanı', icon: Package },
  { value: 'furniture', label: 'Mobilya', icon: Package },
  { value: 'desk', label: 'Masa', icon: Package },
  { value: 'chair', label: 'Sandalye', icon: Package },
  { value: 'cabinet', label: 'Dolap', icon: Package },
  { value: 'machine', label: 'Makine', icon: Wrench },
  { value: 'tool', label: 'Alet/Takım', icon: Wrench },
  { value: 'generator', label: 'Jeneratör', icon: Wrench },
  { value: 'aircondition', label: 'Klima', icon: Wrench },
  { value: 'camera', label: 'Kamera', icon: Package },
  { value: 'security', label: 'Güvenlik Sistemi', icon: Package },
  { value: 'appliance', label: 'Beyaz Eşya', icon: Package },
  { value: 'material', label: 'Malzeme', icon: Package },
